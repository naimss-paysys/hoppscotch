...
## Full .env Reference
```ini
DATABASE_URL=postgresql://hoppscotch:hoppscotch123@postgres-hopps:5432/hoppscotch
REDIS_URL=redis://:redis123@redis:6379
JWT_SECRET=paysyslabsjwtsecretkey32charslong
REFRESH_TOKEN_SECRET=paysyslabsrefreshtokensecret32ch
SESSION_SECRET=paysyslabssessionsecret32charss
...
WHITELISTED_ORIGINS=http://api.paysyslabs.com:8090,http://10.0.150.126:8090,http://localhost:8090
...
OIDC_CLIENT_SECRET=hoppscotchsecret123
...
| Backend can't reach Keycloak (10.0.150.126:8070) | `firewall-cmd --add-masquerade --permanent && firewall-cmd --reload` |
